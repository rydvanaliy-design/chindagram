  ...
  return (
    <div className="flex min-h-screen flex-col bg-gray-50">
      ...
      <main className="mx-auto w-full max-w-xl flex-1 px-4 py-6">
        <h1 className="mb-4 text-lg font-semibold">Requests</h1>

        <section className="mb-6">
          <h2 className="mb-1 text-sm font-semibold text-gray-700">Follow requests</h2>
          <p className="mb-3 text-xs text-gray-500">Your account is private, so new followers need your OK.</p>
          {followRequests.length === 0 ? (
            <p className="rounded-2xl border border-gray-200 bg-white px-4 py-8 text-center text-sm text-gray-400">No pending requests.</p>
          ) : (
        ...
        <section>
          <h2 className="mb-1 text-sm font-semibold text-gray-700">Friend requests</h2>
          <p className="mb-3 text-xs text-gray-500">Friends are mutual — you both have to agree.</p>
